...
{
    public static string BuildAddMigration(MigrationsEntity s, DatabaseProvider provider, string migrationName)
    {
    ...
    public static string BuildUpdateDatabase(MigrationsEntity s, DatabaseProvider provider)
    {
        var project = ResolveMigrationsProjectPath(s, provider);
    ...
    public static string ResolveMigrationsProjectPath(MigrationsEntity s, DatabaseProvider provider)
    {
