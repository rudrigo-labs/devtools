...
public sealed class SqliteSettingsStore : ISettingsStore
{
    ...
    public bool IsConfigured()
    {
        ...
        {
            AppLogger.Error("Failed to check SQLite settings store connectivity.", ex);
            return false;
        }
    }
    ...
    public T GetSection<T>(string sectionName) where T : new()
    {
        ...
        {
            AppLogger.Error($"Failed to read SQLite settings section '{sectionName}'.", ex);
            return new T();
        }
    }
    ...
    public void SaveSection<T>(string sectionName, T data)
    {
        ...
        {
            AppLogger.Error($"Failed to save SQLite settings section '{sectionName}'.", ex);
        }
    }
    ...
    public void CreateDefaultIfNotExists()
    {
        ...
        {
            AppLogger.Error("Failed to create default SQLite settings sections.", ex);
        }
    }
}
