...
public partial class SearchTextWindow : Window
{
    ...
    private bool ValidateInputs(out string errorMessage)
    {
        ...
        if (!ValidationUiService.ValidateRequiredFields(
                out errorMessage,
                ValidationUiService.RequiredPath("Diretorio de Busca", PathSelector, PathSelector.SelectedPath),
                ValidationUiService.RequiredControl("Texto de Pesquisa", SearchTextInput, SearchTextInput.Text)))
        {
