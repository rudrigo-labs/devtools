...
public partial class HarvestWindow : Window
{
    ...
    private bool ValidateInputs(out string errorMessage)
    {
        if (!ValidationUiService.ValidateRequiredFields(
                out errorMessage,
                ValidationUiService.RequiredPath("Diretorio de Origem", SourcePathSelector, SourcePathSelector.SelectedPath),
                ValidationUiService.RequiredPath("Diretorio de Destino", OutputPathSelector, OutputPathSelector.SelectedPath),
                ValidationUiService.RequiredControl("Score Minimo", MinScoreBox, MinScoreBox.Text)))
        {
            return false;
        }
