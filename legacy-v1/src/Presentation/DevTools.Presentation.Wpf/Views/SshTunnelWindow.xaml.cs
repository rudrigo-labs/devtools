...
public partial class SshTunnelWindow : Window
{
    ...
    private bool ValidateInputs(out string errorMessage)
    {
        if (!ValidationUiService.ValidateRequiredFields(
                ...
                ValidationUiService.RequiredControl("Porta SSH", SshPortInput, SshPortInput.Text),
                ValidationUiService.RequiredControl("Usuario SSH", SshUserInput, SshUserInput.Text),
                ValidationUiService.RequiredPath("Arquivo de Chave", IdentityFileSelector, IdentityFileSelector.SelectedPath),
                ValidationUiService.RequiredControl("Bind Local", LocalBindInput, LocalBindInput.Text),
                ValidationUiService.RequiredControl("Porta Local", LocalPortInput, LocalPortInput.Text),
                ValidationUiService.RequiredControl("Host Remoto", RemoteHostInput, RemoteHostInput.Text),
                ValidationUiService.RequiredControl("Porta Remota", RemotePortInput, RemotePortInput.Text)))
        {
            return false;
        }
