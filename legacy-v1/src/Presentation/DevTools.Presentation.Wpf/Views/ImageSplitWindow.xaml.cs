...
public partial class ImageSplitWindow : Window
{
    ...
    private bool ValidateInputs(out string errorMessage)
    {
        ...
        if (!ValidationUiService.ValidateRequiredFields(
                out errorMessage,
                ValidationUiService.RequiredPath("Imagem de Entrada", InputPathSelector, InputPathSelector.SelectedPath),
                ValidationUiService.RequiredControl("Tamanho Minimo", MinSizeBox, MinSizeBox.Text),
                ValidationUiService.RequiredControl("Alpha", AlphaBox, AlphaBox.Text)))
        {
